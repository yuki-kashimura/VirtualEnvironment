...
namespace Dynastream.Fit
{
    public class Field
    {
        ...
        internal Field(string name, byte num, byte type, double scale, double offset, string units, bool accumulated)
        {
            this.name = name;
            this.num = num;
            this.type = type;
        ...
        public long? GetBitsValue(int offset, int bits, byte componentType)
        {
            ...
            if (values.Count == 0)
                return Convert.ToUInt32(Fit.BaseType[Fit.UInt32].invalidValue);

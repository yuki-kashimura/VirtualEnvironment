...
namespace Dynastream.Fit
{
    ...
    public class SegmentLapMesg : Mesg
    {
        ...
        /// <returns>Returns nullable byte representing the AvgLeftPowerPhase field</returns>
        public byte? GetAvgLeftPowerPhase(int index)
        {
            return (byte?)GetFieldValue(75, index, Fit.SubfieldIndexMainField);
        }
        ...
        /// <returns>Returns nullable byte representing the AvgLeftPowerPhasePeak field</returns>
        public byte? GetAvgLeftPowerPhasePeak(int index)
        {
            return (byte?)GetFieldValue(76, index, Fit.SubfieldIndexMainField);
        }
        ...
        /// <returns>Returns nullable byte representing the AvgRightPowerPhase field</returns>
        public byte? GetAvgRightPowerPhase(int index)
        {
            return (byte?)GetFieldValue(77, index, Fit.SubfieldIndexMainField);
        }
        ...
        /// <returns>Returns nullable byte representing the AvgRightPowerPhasePeak field</returns>
        public byte? GetAvgRightPowerPhasePeak(int index)
        {
            return (byte?)GetFieldValue(78, index, Fit.SubfieldIndexMainField);
        }
